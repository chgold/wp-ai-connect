...
function ai_connect_init() {
    if (!class_exists('WooCommerce')) {
        add_action('admin_notices', function() {
            ...
            echo __('AI Connect: WooCommerce is recommended for full functionality.', 'ai-connect');
            echo '</p></div>';
        });
    }
...
function ai_connect_action_links($links) {
    $settings_link = '<a href="admin.php?page=ai-connect">' . __('Settings', 'ai-connect') . '</a>';
